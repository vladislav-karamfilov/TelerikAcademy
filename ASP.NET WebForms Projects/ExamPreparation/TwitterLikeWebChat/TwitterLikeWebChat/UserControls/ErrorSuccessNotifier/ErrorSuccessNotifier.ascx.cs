namespace ErrorHandlerControl
{
    ...
    {
        private const string KeyNotificationMessages = "NotificationMessages";
        private const string KeyShowAfterRedirect = "NotificationMessagesShowAfterRedirect";
        ...
        {
            var dbValidationException = exception as DbEntityValidationException;
