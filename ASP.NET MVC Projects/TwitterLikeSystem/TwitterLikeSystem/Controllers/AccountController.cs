namespace TwitterLikeSystem.Controllers
{
    ...
    {
        public AccountController(ITwitterLikeSystemData data)
            : base(data)
        {
            this.IdentityManager = new AuthenticationIdentityManager(new IdentityStore(new TwitterLikeSystemDbContext()));
        }

        public AccountController(ITwitterLikeSystemData data, AuthenticationIdentityManager manager)
            : this(data)
        {
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                IdentityResult result = await IdentityManager.Authentication
                    .CreateAndSignInExternalUserAsync(AuthenticationManager, new UserProfile() { UserName = model.UserName });
                if (result.Success)
                {
                    return RedirectToLocal(returnUrl);
                }
