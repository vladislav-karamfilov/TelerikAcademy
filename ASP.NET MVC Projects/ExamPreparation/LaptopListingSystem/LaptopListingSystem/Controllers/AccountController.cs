namespace LaptopListingSystem.Controllers
{
    ...
    using LaptopListingSystem.ViewModels.Account;
    ...
    {
        public AccountController(ILaptopListingSystemData data)
            : base(data)
        {
            this.IdentityManager = new AuthenticationIdentityManager(new IdentityStore(new LaptopListingSystemDbContext()));
        }
