namespace Exam.Controllers
{
    ...
    {
        public AccountController(IExamData data)
            : base(data)
        {
            this.IdentityManager = new AuthenticationIdentityManager(new IdentityStore(new ExamDbContext()));
        }

        public AccountController(IExamData data, AuthenticationIdentityManager manager)
            : this(data)
        {
