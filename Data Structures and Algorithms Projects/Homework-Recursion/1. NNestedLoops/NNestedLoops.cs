...
class NNestedLoops
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine("***Simulating execution of N nested loops from 1 to N - these are all");
        Console.WriteLine("permutations with duplicates of the first N natural numbers***");
        Console.Write(decorationLine);
