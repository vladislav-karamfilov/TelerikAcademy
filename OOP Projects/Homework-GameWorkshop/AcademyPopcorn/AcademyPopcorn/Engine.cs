...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        // Task 2: Adding field sleepTime to sleep the thread and adding it to a constuctor of Engine
        ...
        {
            //Task 3: Removing the current rocket from allObjects and staticObjects
